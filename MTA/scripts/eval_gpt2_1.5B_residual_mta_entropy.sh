...
LORA_PATH="distillm-master/results/gpt2/train/spanresidual_mta_entropy_E_1.5B_qwen2.5-7B/${CKPT_STEP}"
OUTPUT_DIR="${BASE_PATH}/eval_outputs/gpt2-1.5B-spanresidual-mta-entropy-${CKPT_STEP}"
