...
LORA_PATH="distillm-master/results/opt/train/spanresidual_mta_opt-2.7B_qwen2.5-7B/${CKPT_STEP}"
OUTPUT_DIR="${BASE_PATH}/eval_outputs/opt-2.7b-spanresidual-mta-${CKPT_STEP}"
