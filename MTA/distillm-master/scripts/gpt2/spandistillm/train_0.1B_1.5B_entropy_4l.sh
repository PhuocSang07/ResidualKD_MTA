...
MAX_LENGTH=256
# runtime
SAVE_PATH="${BASE_PATH}/results/gpt2/train/spandistill_0.1B_1.5B_entropy_4l"
# seed
SEED=42
...
# 4 layer pairs: thêm early layer (12/3) so với config 3l gốc
# word: [12/3]  →  span: [24/6, 36/9, 48/12]
