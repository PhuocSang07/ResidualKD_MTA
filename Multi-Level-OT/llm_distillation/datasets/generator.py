...
sys.path.append(f"/mnt/sinan.fsn/mo.zhu/workspace/llm-recipes/llm_distillation")
...
if __name__ == "__main__":
    ...
    dataset_generated.save_to_disk(f"/mnt/sinan.fsn/mo.zhu/workspace/llm-recipes/llm_distillation/datasets/generated/{args.model_id.split('/')[-1]}/{args.dataset_id.split('/')[-1]}/{args.split_name}")
