...
LORA_PATH="distillm-master/results/gpt2/train/spanresidual_mta_entropy_A_0.1B_qwen1.8B/${CKPT_STEP}"
OUTPUT_DIR="${BASE_PATH}/eval_outputs/gpt2-0.1B-spanresidual-mta-entropy-${CKPT_STEP}"
