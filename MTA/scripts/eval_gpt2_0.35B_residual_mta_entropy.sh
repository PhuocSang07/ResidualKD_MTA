...
LORA_PATH="distillm-master/results/gpt2/train/spanresidual_mta_entropy_B_0.35B_qwen1.8B/${CKPT_STEP}"
OUTPUT_DIR="${BASE_PATH}/eval_outputs/gpt2-0.35B-spanresidual-mta-entropy-${CKPT_STEP}"
...
OPTS+=" --tokenizer openai-community/gpt2-medium"
