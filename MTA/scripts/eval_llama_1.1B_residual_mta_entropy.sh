...
LORA_PATH="distillm-master/results/llama/train/spanresidual_mta_entropy_tinyllama-1.1B_mistral-7B/${CKPT_STEP}"
OUTPUT_DIR="${BASE_PATH}/eval_outputs/tinyllama-1.1B-spanresidual-mta-entropy-${CKPT_STEP}"
