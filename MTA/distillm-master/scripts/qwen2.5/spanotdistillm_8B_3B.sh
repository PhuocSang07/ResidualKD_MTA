...
MAX_LENGTH=256
# runtime
SAVE_PATH="${BASE_PATH}/results/qwen2.5/spanotdistillm_3b"
# seed
SEED=42
...
# span layer mapping (giữ nguyên từ qwen2.5 spandistillm)
...
# OT loss (Multi-Level-OT)
OPTS+=" --w-ot-loss 1.5"
OPTS+=" --ot-top-k 50"
OPTS+=" --ot-temperature 1.0"
OPTS+=" --ot-w-l1 1.0"
OPTS+=" --ot-w-kl 0.1"
OPTS+=" --ot-w-sinkhorn 0.1"
...
CMD="torchrun ${DISTRIBUTED_ARGS} ${BASE_PATH}/span_ot_finetune.py ${OPTS} $@"
