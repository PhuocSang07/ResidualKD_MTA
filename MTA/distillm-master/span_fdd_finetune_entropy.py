...
def prepare_span_indices_and_weights(t_layer_weights, s_layer_weights,
                                     attention_mask, offsets_mapping, spans_offsets, w_t_entropy=None):
...
def get_span_loss(projectors, attention_mask, s_hidden_states, t_hidden_states,
                  offsets_mapping, spans_offsets, teacher_layer_mapping, student_layer_mapping, w_t_entropy=None):
    ...
    (All_Indices, T_Token_Weights_all, S_Token_Weights_all,
     ...
     T_Entropy_Weight_all) = prepare_span_indices_and_weights(t_layer_weights, s_layer_weights,
                                                              attention_mask, offsets_mapping, spans_offsets, w_t_entropy)
    final_loss = 0.0
